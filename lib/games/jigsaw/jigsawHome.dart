...
import 'package:mentifit/games/jigsaw/jigsawGame.dart';
...
class JigsawHome extends StatefulWidget {
  @override
  _JigsawHomeState createState() => _JigsawHomeState();
}
...
class _JigsawHomeState extends State<JigsawHome> {
  ...
  Widget build(BuildContext context) {
    ...
    int diff = 0;
    List difficulty = [["easy", 3], ["medium", 4], ["hard", 5]];
        ...
        actions: [
          SizedBox(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => InstructionsScreen(game: "jigsaw")),);
                },
              ),
          )
        ],
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => JigsawGame(diff: diff)),)
                        },
                          child: Container(
